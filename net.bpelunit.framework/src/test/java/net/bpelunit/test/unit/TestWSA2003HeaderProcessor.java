...
import net.bpelunit.framework.control.soap.WSA2003HeaderProcessor;
 ...
 * 
 */
public class TestWSA2003HeaderProcessor extends SimpleTest {
	...
	public void before() throws SOAPException {
		...
		this.wsaProcessor = new WSA2003HeaderProcessor();
	}
