...
import net.bpelunit.framework.verify.ParallelActivityMustNotHaveDependsOnValidator;
...
public class SpecificationLoader {
	...
	private void validateTestSuite(final XMLTestSuiteDocument doc)
		...
		ITestSuiteValidator[] validators = new ITestSuiteValidator[] {
				...
				new ParallelActivityMustNotHaveDependsOnValidator()
		};
	...
	private Activity readReceive(ITestArtefact parent,
